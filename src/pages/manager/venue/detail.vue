...
<template>
  <view class="wrap">
    ...
    <view class="title">浦江镇第一球场</view>
    <view class="content">
      <view class="plate">
        <view class="plate-header">基本信息</view>
        <view class="plate-content">
          <view class="input-opt">
            <text class="input-opt__text">场馆面积:</text>
            <input type="text" class="input-opt__inp" />
          </view>
          <view class="input-opt">
            <text class="input-opt__text">地理位置:</text>
            <input type="text" class="input-opt__inp" />
          </view>
          <view class="input-opt">
            <text class="input-opt__text">营业时间:</text>
            <input type="text" class="input-opt__inp" />
          </view>
          <view class="input-opt">
            <text class="input-opt__text">联系电话:</text>
            <input type="text" class="input-opt__inp" />
          </view>
        </view>
      </view>
      <view class="plate">
        <view class="plate-header">配置信息</view>
        <view class="plate-content">
          <view class="input-opt">
            <text class="input-opt__text">能否包场:</text>
            <input type="text" class="input-opt__inp" />
          </view>
        </view>
      </view>
      <view class="plate">
        <view class="plate-header">其他</view>
        <view class="plate-content">
          <view class="input-opt">
            <text class="input-opt__text">公交线路:</text>
            <input type="text" class="input-opt__inp" />
          </view>
        </view>
      </view>
